 ...
 *             args[0] is an output parameter to store the native DexParser pointer (***REMOVED***).
...
VECTOR_DEF_NATIVE_METHOD(jobject, DexParserBridge, openDex, jobject data, jlongArray args) {
    ...
    // This "***REMOVED***" will be passed back to other native methods.
 ...
 * @param ***REMOVED*** The pointer to the DexParser object created by `openDex`.
 */
VECTOR_DEF_NATIVE_METHOD(void, DexParserBridge, closeDex, jlong ***REMOVED***) {
    if (***REMOVED*** != 0) delete reinterpret_cast<DexParser *>(***REMOVED***);
}

/**
 * @brief Iterates through classes, fields, and methods, calling back to a Java
 * visitor.
 * @param ***REMOVED*** The pointer to the DexParser object.
 ...
 */
VECTOR_DEF_NATIVE_METHOD(void, DexParserBridge, visitClass, jlong ***REMOVED***, jobject visitor,
    ...
    auto &dex = *reinterpret_cast<DexParser *>(***REMOVED***);
