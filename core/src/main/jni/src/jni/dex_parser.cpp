...
namespace lspd {
    ...
    LSP_DEF_NATIVE_METHOD(void, DexParserBridge, closeDex, jlong ***REMOVED***) {
        if (***REMOVED*** != 0)
            delete reinterpret_cast<DexParser *>(***REMOVED***);
    }

    LSP_DEF_NATIVE_METHOD(void, DexParserBridge, visitClass, jlong ***REMOVED***, jobject visitor,
