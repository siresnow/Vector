...
public class LSPosedDexParser implements DexParser {
    ...
    synchronized public void close() {
        if (***REMOVED*** != 0) {
            DexParserBridge.closeDex(***REMOVED***);
            ***REMOVED*** = 0;
        }
    }
    ...
    synchronized public void visitDefinedClasses(@NonNull ClassVisitor visitor) {
        ...
        DexParserBridge.visitClass(***REMOVED***, visitor, FieldVisitor.class, MethodVisitor.class, classVisitMethod, fieldVisitMethod, methodVisitMethod, methodBodyVisitMethod, stopMethod);
    }
}
