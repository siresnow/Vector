    ...
    namespace hidden_api {
        ...
        CREATE_FUNC_SYMBOL_ENTRY(void, DexFile_setTrusted, JNIEnv *env, jclass clazz,
            ...
            if (LIKELY(DexFile_setTrustedSym != nullptr)) {
                ...
                DexFile_setTrustedSym(env, clazz, j_***REMOVED***);
        ...
        maybeSetTrusted(JNIEnv *env, jclass clazz, jobject class_loader, jobject j_***REMOVED***) {
            ...
            for (auto current = lspd::Context::GetInstance()->GetCurrentClassLoader();
                ...
                if (!current || env->IsSameObject(class_loader, current)) {
                    DexFile_setTrusted(env, clazz, j_***REMOVED***);
        ...
        CREATE_HOOK_STUB_ENTRIES(
                ...
                jobjectArray dex_elements), {
                    auto j_***REMOVED*** = backup(env, clazz, javaSourceName, javaOutputName, flags,
                                           class_loader,
                                           dex_elements);
                    maybeSetTrusted(env, clazz, class_loader, j_***REMOVED***);
                    return j_***REMOVED***;
                }
        );
        ...
        CREATE_HOOK_STUB_ENTRIES(
                ...
                jobject class_loader,
                jobjectArray dex_elements), {
                    auto j_***REMOVED*** = backup(env, clazz, buffers, arrays, jstarts, jends,
                                           class_loader,
                                           dex_elements);
                    maybeSetTrusted(env, clazz, class_loader, j_***REMOVED***);
                    return j_***REMOVED***;
        ...
        CREATE_HOOK_STUB_ENTRIES(
                ...
                jint start,
                jint end), {
                    auto j_***REMOVED*** = backup(env, clazz, buffer, start, end);
                    DexFile_setTrusted(env, clazz, j_***REMOVED***);
                    return j_***REMOVED***;
                }
        );
